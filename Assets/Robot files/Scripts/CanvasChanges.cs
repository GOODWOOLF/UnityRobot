...
public class CanvasChanges : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Green Cube
        greencube_pos_x.text = ((GreenCube.transform.localPosition.y) * 1000).ToString();
        greencube_pos_y.text = ((-GreenCube.transform.localPosition.z) * 1000).ToString();
        greencube_pos_z.text = ((-GreenCube.transform.localPosition.x) * 1000).ToString();
        greencube_rot_x.text = ((GreenCube.transform.localEulerAngles.x) * 1000).ToString();
        greencube_rot_y.text = ((GreenCube.transform.localEulerAngles.z) * 1000).ToString();
        greencube_rot_z.text = ((GreenCube.transform.localEulerAngles.y) * 1000).ToString();

        // Blue Cube
        bluecube_pos_x.text = ((BlueCube.transform.localPosition.y) * 1000).ToString();
        bluecube_pos_y.text = ((-BlueCube.transform.localPosition.z) * 1000).ToString();
        bluecube_pos_z.text = ((-BlueCube.transform.localPosition.x) * 1000).ToString();
        bluecube_rot_x.text = ((BlueCube.transform.localEulerAngles.x) * 1000).ToString();
        bluecube_rot_y.text = ((BlueCube.transform.localEulerAngles.z) * 1000).ToString();
        bluecube_rot_z.text = ((BlueCube.transform.localEulerAngles.y) * 1000).ToString();

        // Camera Origin
        // Red Cube
        redcube_pos_x_cam.text = ((RedCube.transform.localPosition.y) * 1000).ToString();
        redcube_pos_y_cam.text = ((RedCube.transform.localPosition.z) * 1000).ToString();
        redcube_pos_z_cam.text = ((-RedCube.transform.localPosition.x) * 1000).ToString();
        ...
        // Green Cube
        greencube_pos_x_cam.text = ((GreenCube.transform.localPosition.y) * 1000).ToString();
        greencube_pos_y_cam.text = ((GreenCube.transform.localPosition.z) * 1000).ToString();
        greencube_pos_z_cam.text = ((-GreenCube.transform.localPosition.x) * 1000).ToString();
        ...
        // Blue Cube
        bluecube_pos_x_cam.text = ((BlueCube.transform.localPosition.y) * 1000).ToString();
        bluecube_pos_y_cam.text = ((BlueCube.transform.localPosition.z) * 1000).ToString();
        bluecube_pos_z_cam.text = ((-BlueCube.transform.localPosition.x) * 1000).ToString();
        ...
        // Sorting Area
        // Red Cube
        redcube_pos_x_area.text = ((RedArea.transform.localPosition.y) * 1000).ToString();
        redcube_pos_y_area.text = ((-RedArea.transform.localPosition.z) * 1000).ToString();
        redcube_pos_z_area.text = ((-RedArea.transform.localPosition.x) * 1000).ToString();

        // Green Cube
        greencube_pos_x_area.text = ((GreenArea.transform.localPosition.y) * 1000).ToString();
        greencube_pos_y_area.text = ((-GreenArea.transform.localPosition.z) * 1000).ToString();
        greencube_pos_z_area.text = ((-GreenArea.transform.localPosition.x) * 1000).ToString();

        // Blue Cube
        bluecube_pos_x_area.text = ((BlueArea.transform.localPosition.y) * 1000).ToString();
        bluecube_pos_y_area.text = ((-BlueArea.transform.localPosition.z) * 1000).ToString();
        bluecube_pos_z_area.text = ((-BlueArea.transform.localPosition.x) * 1000).ToString();
